# [All the Mods 10-2.31](https://www.curseforge.com/minecraft/modpacks/all-the-mods-10) on Curseforge
<!-- toc -->
...
The docker on the first run will download the same version as tagged `All the Mods 10-2.31` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "All the Mods 10-2.31 Server Powered by Docker"
