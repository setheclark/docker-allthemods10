# [All the Mods 10-3.0](https://www.curseforge.com/minecraft/modpacks/all-the-mods-10) on Curseforge
<!-- toc -->
...
The docker on the first run will download the same version as tagged `All the Mods 10-3.0` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
